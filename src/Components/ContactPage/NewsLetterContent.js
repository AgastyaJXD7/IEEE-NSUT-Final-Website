...
//Always make image name in lowercase characters without special characters to avoid prospective import errors 
    ...
    <div>
        ...
        <div className="main-box">
            <div className="text-box">
                ...
                <button className="Button_Default" id="btn3">Contact Us</button>
            </div>
